...
# def send_email(v_uc_email_df, ph_status_counts, ph_aging_counts, bart_error_orders, bart_duplicate_orders, bart_no_prov_orders, vfx3_ihc_count, vfx3_adir_count, vfx3_adus_count, zisxerror_orders): #bart_no_prov_email_df
def send_email(metrics_for_email): #bart_no_prov_email_df
